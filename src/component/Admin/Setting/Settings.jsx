...
const Settings = () => {
  ...
  return (
    <div>
      <div className=" grid grid-flow-col grid-rows-3 gap-4 flex h-screen bg-gray-100">
        <div className=" row-span-3 hidden md:block overflow-y-auto scrollbar-hide">
          <Sidebar />
        </div>
              ...
              <Card className="w-full max-w-lg border shadow-xl p-6">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-2sm">
                    Enter a new password below to update your <br></br>{" "}
                    credentials.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...form}>
                    <form>
                      ...
                      <CardFooter className="flex justify-center mt-5">
                        <Button
                          type="submit"
                          className="w-[300px] bg-blue-500 shadow-lg hover:bg-blue-600"
                        >
                          CHANGE PASSWORD
                        </Button>
                      </CardFooter>
