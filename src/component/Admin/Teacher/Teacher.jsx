      ...
      <SidebarProvider style={{ "--sidebar-width": "19rem" }}>
        ...
        <SidebarInset>
          ...
          <div className="w-full shadow-md rounded-lg flex flex-col sm:flex-row items-center justify-between px-4 sm:px-8 py-4 mt-6 space-y-4 sm:space-y-0">
            <div className="flex items-center border border-blue-300  rounded-lg px-3 py-2  sm:max-w-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 md:grid-cols-1 gap-6 p-6  min-h-screen place-items-center">
            {Teachers.map((teacher, index) => (
              <Card
                key={index}
                className="w-[21rem] shadow-xl rounded-xl border border-blue-500 p-6 relative"
              >
                {/* 3-dot menu button */}
