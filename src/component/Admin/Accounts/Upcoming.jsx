          ...
          <div className="w-full shadow-md shadow-blue-300/30 rounded-lg flex flex-wrap sm:flex-nowrap items-center justify-between px-4 sm:px-8 py-4 gap-3">
            ...
            <div className="flex gap-3">
              <select
                ...
                className="border border-blue-300 bg-transparent rounded-lg px-4 pe-1 py-2 text-sm"
              >
                {[
                  "01",
                  "02",
              ...
              <select
                ...
                className="border border-blue-300 bg-transparent rounded-lg px-4 py-2 text-sm"
              >
                {yearOptions.map((y) => (
