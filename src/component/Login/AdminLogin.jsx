                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 sm:space-y-10">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="block margin text-gray-700 font-semibold text-lg sm:text-xl">Password</FormLabel>
                                        <FormControl>
                                            <div className="relative flex items-center">
                                                <Input
                                ...
                                render={({ field }) => (
                                    <FormItem className="">
                                        <div className="flex margin items-center space-x-3">
                                            <Checkbox id="terms" className="w-4 sm:w-5 h-4 sm:h-5" checked={field.value} onCheckedChange={field.onChange} />
                                            <Label htmlFor="terms" className="text-gray-700  checkbox text-sm sm:text-lg">Accept terms and conditions</Label>
                                        </div>
                                        <FormMessage />
                                    </FormItem>
                                )}
