...
import { add_notification, delete_notify, get_notification } from "../Api/Notification"
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(add_notification.fulfilled, (state, action) => {
                state.loading = false,
                    state.notii.push(action.payload)
            })
            ...
            .addCase(delete_notify.fulfilled, (state, action) => {
                state.loading = false;
                state.notii = state.notii.filter((b) => b.id !== action.payload);
