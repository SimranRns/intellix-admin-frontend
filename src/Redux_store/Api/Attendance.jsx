...
export const fetchAttendance = createAsyncThunk(
  ...
  async ({ sessionID, name, batch, enrollment_id, page, limit },  { rejectWithValue }) => {
      ...
      try {
          ...
          url.searchParams.append('sessionId', sessionID || 19);
          ...
          return {
              data: result.data.data,   // students array
              total: result.data.total, // total students
              page: result.data.page,   // current page
              limit: result.data.limit  // page limit
          };
